				...
				<div className="warehouse-details-list__top">
					<div className="warehouse-details-list__top--left">
						<h1 className="warehouse-details-list__header">
							<Link to="/">
								<img
									className="warehouse-details-list__arrow-back"
									src={arrowBackIcon}
									alt="arrow back"
								/>
							</Link>
						...
						<button
							...
							className="warehouse-details-list__button">
							<EditIcon color="#FFFFFF" />{" "}
							<span className="warehouse-details-list__button-text">Edit</span>
						</button>
					</div>
				</div>
				...
				<div className="warehouse-details-information">
					<div className="warehouse-details-information__right">
						<div className="warehouse-details-information__item">
							<h4 className="warehouse-details-information__header">
								warehouse address:
							</h4>
							<p className="warehouse-details-information__text">
