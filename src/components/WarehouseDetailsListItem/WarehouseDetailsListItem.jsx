...
function WarehouseDetailsListItem({ item: { category, item_name, quantity, status } }) {
  return (
      <>
      <article className="warehouse-details-item">
        <div className="warehouse-details-item__container--warehouse">
          <h3 className="warehouse-details-item__header--tb warehouse-details-item__header-link">{item_name} <img className="warehouse-item__icon" src={chevronIcon} alt="chevron" /></h3>
          <div className="warehouse-details-item__mb">
            <h4 className="warehouse-details-item__header">inventory item</h4>
            <h3 className="warehouse-details-item__header--mb warehouse-details-item__header-link">{item_name} <img className="warehouse-item__icon" src={chevronIcon} alt="chevron" /></h3>
          </div>
          <div className="warehouse-details-item__mb">
        ...
        <div className="warehouse-details-item__container--contact-name">
          <div className="warehouse-details-item__text warehouse-item__text--tb">
            <button className={ status === 'In Stock' ? 'warehouse-details-item__pill warehouse-details-item__pill--is' : 'warehouse-details-item__pill warehouse-details-item__pill--oos' }>{status}</button>
          </div>
          <div className="warehouse-details-item__mb">
